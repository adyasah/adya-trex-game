...
function setup(){
  ...
  g2=createSprite(300,190,600,1)
  g2.visible=false
  
  cGroup=new Group()
  oGroup=new Group()
  
  gO=createSprite(300,70)
...
function draw(){
  ...
  if(gameState===play){
     ...
     if(keyDown("space")&&trex.collide(g2)){
    trex.velocityY=-10
    jump.play()
     }
...
function manyClouds(){
  if(frameCount%80==0){
    cloud=createSprite(600,100,20,30)
...
function mo(){
  if(frameCount%60==0){
      obsticals=createSprite(600,170,20,20)
